  ...
  return (
    ...
    >
      <View style={[stil.karte, { backgroundColor: farben.flaeche, borderColor: farben.rand }]}>
        <Text style={[schrift.betont, { color: farben.text }]}>Wozu diese Angaben dienen</Text>
      ...
      <Text style={[schrift.ueberschrift, { color: farben.text, marginTop: abstand.s }]}>Auswertung</Text>
      <Feld
